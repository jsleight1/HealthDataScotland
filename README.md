...
therefore the author accepts no liability and provide no guarantees
related to the functionality of the app and accuracy of the data. The
original published data sets should always always be consulted when

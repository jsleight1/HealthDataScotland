...
HealthDataScotland also contains a `renv.lock` file which can be used to create 
...
Open Data platform](https://www.opendata.nhs.scot/). Spatial data for interactive maps are
